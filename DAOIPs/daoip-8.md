...
| Ownership of assets | `[MANDATORY]` The DAO should release a public list of all assets it owns and controls. The list could include crypto tokens, ENS names and other naming services, dApps, frontends, physical assets, etc. |
